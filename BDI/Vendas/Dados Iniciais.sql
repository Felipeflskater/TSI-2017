...
insert into clientes (nm_cliente, cd_cliente, sexo, nr_residencia, complemento, cep, cpf, profissao) values ('Paula Silveira',40,'F',25,null,'95010100','62044567821', 'Médica');
insert into clientes (nm_cliente, cd_cliente, sexo, nr_residencia, complemento, cep, cpf, profissao) values ('Afonso Mendes',50,'M',2123, 304, '95010100','62044567820', 'Analista de Sistemas');
...
insert into produto (cd_produto, nm_produto, vl_unitario, qtd_produto) values (4,'Caneta',3.00, 120); 
insert into produto (cd_produto, nm_produto, vl_unitario, qtd_produto) values (5,'apontador',15.00, 45);
